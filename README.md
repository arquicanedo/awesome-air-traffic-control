...
- [CRC](https://vnas.vatsim.net/crc) - Radar client for the VATSIM network, built on the vNAS platform.
- [EuroScope](http://www.euroscope.hu/) - Radar client for VATSIM, extensible through community plugins and sector files.
- [vatSys](https://virtualairtrafficsystem.com/) - Radar client for VATSIM, modeled on the Australian ATC system.
- [VRC](https://vrc.rosscarlson.dev/) - Radar client for VATSIM modeled on US terminal and enroute displays.
...
- [SimAware TRACON](https://github.com/vatsimnetwork/simaware-tracon-project) - Open TRACON boundary definitions used by the VATSIM network.

## Training and reference

- [Visual Vectoring](https://visualvectoring.com/) - Vectoring and separation courses with an accompanying simulator.

## Adjacent

- [Air Defender](https://store.steampowered.com/app/3985030/Air_Defender/) - Air defense radar operations.
